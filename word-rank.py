...
###########
#łączenie podanej listy w jeden długi string
consent = ""
...
#tworzenie set i liczenie wystepowania slow
setone = set()
for i in consent:
    setone.add((i, consent.count(i)))
#zamiana na list, by posortowac i printowac
s = list(setone)
s.sort(key=lambda row: (row[1]), reverse=True)
# print(s)
